...
if ( $upsells ) : ?>
    ...
    $product_cols = shortcode_atts(
        ...
        Airi()->settings()->get('upsell_products_columns')
    );
    ...
    $title = Airi()->settings()->get('upsell_product_title') ? Airi()->settings()->get('upsell_product_title') : _x( 'You may also like&hellip;', 'front-view', 'airi' );
    $sub_title = Airi()->settings()->get('upsell_product_subtitle') ? Airi()->settings()->get('upsell_product_subtitle') : '';
    ?>
