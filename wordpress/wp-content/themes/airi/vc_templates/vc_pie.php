...
$output = '<div ' . implode( ' ', $wrapper_attributes ) . ' class= "' . esc_attr( $css_class ) . '" data-pie-value="' . esc_attr( $value ) . '" data-pie-label-value="" data-pie-units="" data-pie-color="' . esc_attr( $color ) . '">';
$output .= '<div class="wpb_wrapper">';
$output .= '<div class="vc_pie_wrapper">';
$output .= '<span class="vc_pie_chart_back" style="border-color: ' . esc_attr( $color ) . '"></span>';
$output .= '<span class="vc_pie_chart__label"><span class="vc_pie_chart__label1"><span class="vc_pie_chart_value"></span><sup>'.esc_attr( $units ).'</sup></span><span class="vc_pie_chart__label2">'.esc_attr( $label_value ).'</span></span>';
