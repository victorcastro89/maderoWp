...
class WXR_Importer extends WP_Importer {
	...
	protected function process_attachment( $post, $meta, $remote_url ) {
		...
		if(!empty($_wp_attached_file) && file_exists( $this->wp_upload_dir['basedir'] . '/' . $_wp_attached_file)){
			$upload = array(
				'file' => $this->wp_upload_dir['basedir'] . '/' . $_wp_attached_file,
				'url'  => $this->wp_upload_dir['baseurl'] . '/' . $_wp_attached_file
			);
		}
		else{
